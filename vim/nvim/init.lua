...
vim.api.nvim_set_keymap('n', '<leader>tt', ':ToggleTheme<CR>', { noremap = true, silent = true, desc = 'Toggle theme' })
...
-- Switch to the next buffer using Shift + J
vim.api.nvim_set_keymap('n', '<C-j>', ':bnext<CR>', { noremap = true, silent = true })

-- Switch to the previous buffer using Shift + K
...
luarocks.setup_paths() -- Ensure LuaRocks paths are correctly set
...
require('packer').startup(function()
  ...
  use {
    ...
    run = ':TSUpdate', -- Automatically update parsers when installing
  }
end)
